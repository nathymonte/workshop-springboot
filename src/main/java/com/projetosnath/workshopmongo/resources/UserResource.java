...
public class UserResource {
	...
	@RequestMapping(method=RequestMethod.POST) //opção alternativa @PostMapping	
	...
	@RequestMapping(value="/{id}", method=RequestMethod.DELETE) //opção alternativa @DeleteMapping	
	public ResponseEntity<Void> delete(@PathVariable String id) {		
		service.delete(id);
		return ResponseEntity.noContent().build();
	}
	
	@RequestMapping(value="/{id}", method=RequestMethod.PUT) //opção alternativa @PutMapping	
	...
	@RequestMapping(value="/{id}/posts", method=RequestMethod.GET) //opção alternativa @GetMapping	
